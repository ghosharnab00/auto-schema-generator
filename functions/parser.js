...
const hirationblogdata = async () => {
   ...
   try {
    let bgimg = $('.post-full-image').attr("style").replace("background: linear-gradient(0deg, rgba(0, 0, 0, 0.64), rgba(0, 0, 0, 0.64)),url(","").replace('background-image: url(',"").replace(");","").split('?')[0];
